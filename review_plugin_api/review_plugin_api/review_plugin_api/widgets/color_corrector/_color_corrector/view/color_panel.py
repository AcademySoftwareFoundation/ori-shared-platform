...
from review_plugin_api.widgets.color_corrector.widgets.color_circle import ColorCircle
from review_plugin_api.widgets.color_corrector._color_corrector.view.color_sliders \
    import ColorSliders
