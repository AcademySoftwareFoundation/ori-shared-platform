...
class ClipAttrCutLengthFt:

    @property
    def id_(self)->str:
        return "cut_length_ft"

    @property
    def name(self)->str:
        return "Cut Length (ft)"
    ...
    def get_value(self, source_group:str)->int:
        ...
        cut_length_ft = round(cut_length / 16.0, 3)
        return cut_length_ft


ClipAttrApiCore.get_instance()._add_attr(ClipAttrCutLengthFt())
