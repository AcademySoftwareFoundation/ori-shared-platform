...
from review_plugin_api.widgets.color_corrector.widgets import input_line_edit

from review_plugin_api.widgets.color_corrector._color_corrector.view.color_panel \
    import ColorPanel
from review_plugin_api.widgets.color_corrector._color_corrector.view.slider \
    import Slider
...
class ColorKnob(QtWidgets.QWidget):
    ...
    def __init__(self, name, hints, parent=None, is_color=True, width=LABEL_WIDTH):
        ...
        main_layout.addWidget(self.__color_panel)
