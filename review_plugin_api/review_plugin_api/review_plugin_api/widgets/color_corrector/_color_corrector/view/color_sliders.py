...
from review_plugin_api.widgets.color_corrector.\
    _color_corrector.view.clearing_slider_label import ClearingSliderLabel
from review_plugin_api.widgets.color_corrector.\
    _color_corrector.view.slider import Slider
